...
const Resume = (props) => {
  ...
  let education = props.data.education.map(function (educationObj) {
    return (
  ...
  let work = props.data.work.map(function (work) {
    return (
  ...
  let skills = props.data.skills.map(function (skills) {
